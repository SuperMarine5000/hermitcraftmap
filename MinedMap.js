...
var MinedMapLayer = L.GridLayer.extend({
	initialize: function (mipmaps, layer) {
		...
		this.options.attribution = '<a href="https://github.com/saadbruno/hermitcraftmap">Source</a> | Map Tiles Generated by <a href="https://github.com/NeoRaider/MinedMap">MinedMap</a>';
	...
	createTile: function (coords, done) {
		...
		*/
		...
		if (coords.x >= mipmap.info.minX && coords.x <= mipmap.info.maxX &&
			...
			tile.src = 'data/hc'+ season + '/' +this.layer+'/'+z+'/r.'+coords.x+'.'+coords.y+'.png';
...
window.createMap = function () {
	...
	xhr.open('GET', 'data/hc'+ season +'/info.json', true);
	xhr.send();
}
